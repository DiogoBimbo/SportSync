...
class Styles {
  ...
  static const TextStyle tituloForte = TextStyle(
    fontFamily: 'Inter',
    fontSize: 21,
    fontWeight: FontWeight.bold,
  );
  ...
  static const Color corLink = Color.fromARGB(255, 125, 113, 255);
  ...
  static const Color gold = Color.fromARGB(255, 221, 194, 39);
  static const Color silver = Color.fromARGB(255, 189, 189, 189);
  static const Color bronze = Color.fromARGB(255, 205, 128, 50);
